...
export default function AuthSimpleLayout({ children, title, description }: AuthLayoutProps) {
    return (
        <div className="min-h-svh bg-slate-50 transition-colors lg:grid lg:grid-cols-[1.05fr_0.95fr] dark:bg-slate-950">
            <aside className="relative hidden min-h-svh overflow-hidden bg-slate-950 p-10 text-white lg:flex lg:flex-col xl:p-14">
                <div className="absolute top-1/3 -left-32 h-80 w-80 rounded-full bg-amber-400/10 blur-3xl" />
                ...
                <div className="relative z-10 my-auto max-w-xl py-16">
                    ...
                    <h2 className="mt-6 text-4xl leading-tight font-bold tracking-tight xl:text-5xl">Vendez, enchérissez et remportez.</h2>
                    ...
                    <div className="mt-10 grid gap-5">
                        <div className="flex items-start gap-4">
                            <span className="rounded-lg bg-white/10 p-2 text-amber-300">
                ...
                <p className="relative z-10 text-sm text-slate-500">© {new Date().getFullYear()} Gestion Enchères</p>
            </aside>
            ...
            <main className="flex min-h-svh flex-col dark:text-slate-100">
                <div className="flex h-20 items-center justify-between px-5 sm:px-8 lg:hidden">
                    <Link href={route('home')} className="flex items-center gap-2.5 font-bold text-slate-950 dark:text-white">
                        <span className="rounded-lg bg-amber-400 p-2">
                ...
                <div className="flex flex-1 items-center justify-center px-4 py-8 sm:px-8 lg:px-12">
                    <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none dark:border-slate-800 dark:bg-slate-900">
                        <div className="mb-8">
