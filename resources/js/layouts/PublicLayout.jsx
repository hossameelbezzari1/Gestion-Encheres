                        ...
                        {user ? (
                            <>
                                <Link
                                    ...
                                    className="inline-flex items-center gap-2 rounded-lg bg-slate-900 px-3 py-2 text-sm font-semibold text-white dark:bg-amber-400 dark:text-slate-950"
                                >
                            ...
                            <>
                                <Link href={route('login')} className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-700 dark:text-slate-200">
                                    Connexion
                                </Link>
                                <Link href={route('register')} className="rounded-lg bg-amber-400 px-3 py-2 text-sm font-semibold text-slate-950">
                                    Inscription
                                </Link>
                            </>
                        )}
