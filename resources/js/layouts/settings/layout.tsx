...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div>
            <div className="mb-6">
                <h1 className="text-2xl font-bold tracking-tight text-slate-950">Paramètres</h1>
                <p className="mt-1 text-sm text-slate-500">Gérez votre profil, la sécurité et les préférences de votre compte.</p>
            </div>
