    ...
    return (
        <label className="block" htmlFor={inputId}>
            ...
            <select
                id={inputId}
                required={required}
                className={cn('h-11 w-full rounded-lg border border-slate-300 bg-white px-3 text-slate-900 outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-200', error && 'border-red-500', className)}
                {...props}
            >
