...
export default function Header({ user, onMenu }) {
    return (
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 bg-white/90 px-4 backdrop-blur transition-colors md:px-6 dark:border-slate-800 dark:bg-slate-900/90">
            <button
                onClick={onMenu}
